...
<head runat="server">
    ...
    <style>
        ...
        .bg-image{
            background-image : url('../Image/login.jfif');
            ...
            <div class="row">
                <div class="col-lg-10 col-xl-7 mx-auto">
                    ...
                    <div class="form-group mb-3 mb-2">
                        <input id="inputPassword" type="password" placeholder="Password" required="" runat="server" autofocus=""  class="form-control rounded-pill border-0 shadow-sm px-4" />
                     </div>
